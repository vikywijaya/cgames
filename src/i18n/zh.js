...
export default {
  ...
  app: {
    ...
    view: '查看 →',
    // Home — Option 1A
    levelOf: '第 {current} 级，共 {total} 级',
    progressToNext: '{pct}% 达到',
    todaysChallengeEyebrow: '今日挑战',
    dailyChallengeCardDesc: '今天为你精选了 2 款新游戏。',
    playNow: '立即开始',
    browseGamesShort: '{count} 款游戏 · {categories} 类',
    yourScores: '你的成绩',
    scoresShort: '最佳与进度',
    yourFavorites: '你的收藏',
    seeAll: '查看全部',
    favoritesEmptyHomeTitle: '还没有收藏',
    favoritesEmptyHomeDesc: '点按任意游戏上的 ♥ 即可固定到这里。',
    ...
    points: '积分',
    pctOfTheWay: '已完成 {pct}%',
    playFirstGame: '开始你的第一场游戏',
    statGamesPlayed: '已玩游戏',
    statAvgBest: '平均最佳',
    statSessions: '总次数',
    to: '到',
    best: '最佳',
    ...
    bestScore: '最佳分数',
    bestTime: '最佳时间',
    motiv0: '准备好锻炼大脑了吗？选一个游戏开始吧！',
    motiv1: '第一次体验很棒！探索更多游戏保持头脑活跃。',
    motivTry: '你已经玩了 {plays} 次——今天试试不同的游戏吧！',
    motivHigh: '令人印象深刻！玩了 {played} 个游戏，平均最佳分数 {avg}%——太厉害了！',
    motivExplore: '你已经探索了 {total} 个游戏中的 {played} 个，平均最佳 {avg}%。继续发现！',
    motivDefault: '{played} 个游戏共 {plays} 次——还有 {remaining} 个游戏等你来玩！',
    domains: {
      'Visual Memory': '视觉记忆', 'Verbal Memory': '语言记忆', 'Sequence Memory': '序列记忆',
      'Working Memory': '工作记忆', 'Spatial Memory': '空间记忆', 'Visual Pattern': '视觉模式',
      'Pattern Recognition': '模式识别', 'Selective Attention': '选择性注意',
      'Reaction Speed': '反应速度', 'Visual Scanning': '视觉扫描', 'Attention': '注意力',
      'Inhibitory Control': '抑制控制', 'Visual Attention': '视觉注意', 'Coordination': '协调能力',
      'Mental Arithmetic': '心算', 'Number Recognition': '数字识别',
      'Numeric Ordering': '数字排序', 'Numeric Logic': '数字逻辑', 'Numeric Reasoning': '数字推理',
      'Visual Reasoning': '视觉推理', 'Logic Puzzles': '逻辑谜题', 'Spatial Reasoning': '空间推理',
      'Logic & Sorting': '逻辑与排序', 'Visual Cognition': '视觉认知', 'Geography': '地理',
    },
  },
  common: {
    correct: '✓ 正确！',
    ...
    levelComplete: '关卡完成！',
    alreadyRecalled: '已经回忆过了',
    words: '个单词',
    studyPhase: '学习阶段',
    memoriseWords: '记住所有单词',
    imReady: '我准备好了！',
    recalledSoFar: '已回忆',
    finish: '完成',
    yourTurn: '轮到你了——重复图案！',

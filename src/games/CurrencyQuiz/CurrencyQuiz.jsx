...
function CurrencyQuizGame({ difficulty, onComplete, reportScore, secondsLeft }) {
  ...
  return (
    ...
    >
      {({ onComplete: sc, reportScore, secondsLeft }) => (
        <CurrencyQuizGame difficulty={difficulty} onComplete={sc} reportScore={reportScore} secondsLeft={secondsLeft} />
      )}
    </GameShell>
  );
}
